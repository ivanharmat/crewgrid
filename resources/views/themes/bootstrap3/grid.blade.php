<div x-data="crewGridResize({{ $minColumnWidth }})" @pointermove.window="move($event)" @pointerup.window="stop()">
    ...
    <div class="row" style="margin-bottom: 8px;">
        ...
        <div class="{{ $toolbarView ? 'col-sm-6' : 'col-sm-8' }} text-right">
            ...
            @endif
            <select class="{{ $this->uiClass('select') }}" style="width: auto; display: inline-block;" wire:change="setPerPage($event.target.value)" title="Rows per page">
